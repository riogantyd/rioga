...
export const caseStudies: CaseStudy[] = [
  // ===========================================================
  {
    ...
    subtitle:
      "Replacing Word templates and a paper logbook with one searchable system",
    cardDescription:
    ...
    thumbnail: "/images/awp.png",
    meta: [
      { label: "Role", value: "Sole developer and analyst" },
      {
        label: "Client",
        value:
          "PT Adiwarna Pratama — NDT, lifting gear and drill stem inspection",
      },
      {
        label: "Timeline",
        value: "Jul 2024 – Jan 2026, across six engagements",
      },
      {
        label: "Team",
        value: "Worked alone; reported to the Technical Manager",
      },
      { label: "Stack", value: "Laravel, React, MySQL" },
      {
        label: "Outcome",
        value:
          "Nine document workflows moved off Word and the paper archive into one searchable system",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Everything ran through Microsoft Word and a physical archive room.",
          },
          {
            type: "p",
          ...
          {
            type: "p",
            text: "Four things were actually costing time, and only one of them was the obvious one:",
          },
          {
            type: "ul",
            items: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "Partway through, a request came in to digitize the inspector field forms. I turned it down.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          ...
          //   caption:
          //     "The work order flow before and after: Word, signature, physical archive and logbook, against structured entry and search.",
          // },
        ],
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            attribution:
              "Agung Pramudya — Technical Manager, PT Adiwarna Pratama",
          },
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "I\u2019d design the whole flow before writing any code.",
          },
          {
            type: "p",
  ...
  // ===========================================================
  {
    ...
    subtitle:
      "Two national products, one product manager, and a team that had never run Scrum",
    cardDescription:
    ...
    thumbnail: "/images/bkd.png",
    meta: [
      {
        label: "Role",
        value: "Product Manager — sole PM across both workstreams",
      },
      {
        label: "Client",
        value:
          "Ditjen Pendidikan Tinggi, Kemendikbudristek (now Kemdiktisaintek)",
      },
      { label: "Timeline", value: "Sep – Dec 2024 (4 months)" },
      {
        label: "Team",
        value: "12 people across two squads — 7 on BKD, 5 on CAT",
      },
      { label: "Tools", value: "Jira, Notion, Slack, Google Meet" },
      {
        label: "Outcome",
        value:
          "BKD delivered complete; CAT delivered 4 of 5 submenus. ~400 backlog items across 11 sprints",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        blocks: [
          {
            type: "h3",
            text: "I spent the first sprint teaching, not shipping",
          },
          {
            type: "p",
          ...
          {
            type: "h3",
            text: "I made acceptance criteria and definition of done non-negotiable",
          },
          {
            type: "p",
          ...
          {
            type: "h3",
            text: "On CAT, I stopped feature work to rebuild shared understanding",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          {
            type: "h3",
            text: "Get the team technically ready before sprint one",
          },
          {
            type: "p",
  ...
  // ===========================================================
  {
    ...
    title:
      "APPIKS — Turning a School Safeguarding Policy into Something Students Actually Open",
    subtitle:
      "A daily mood check-in that gives counselors early signal, instead of a reporting form nobody fills in",
    cardDescription:
    ...
    thumbnail: "/images/appiks.png",
    meta: [
      {
        label: "Role",
        value:
          "Product Owner — requirements, backlog, roadmap, delivery, field validation",
      },
      {
        label: "Client",
        value:
          "Arifah Suryaningsih, doctoral researcher, Universitas Negeri Yogyakarta",
      },
      {
        label: "Timeline",
        value: "Aug – Nov 2025 (2.5 months to full delivery)",
      },
      ...
      { label: "Scope", value: "6 user roles, 30+ features" },
      {
        label: "Outcome",
        value:
          "Validated with 120 users across 6 schools at 4.1–4.3/5.0; copyright registered",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        blocks: [
          {
            type: "h3",
            text: "A daily mood check-in instead of an incident reporting form",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            type: "p",
            text: "I pushed back on it, and this was the longest conversation we had on the product.",
          },
          {
            type: "ul",
            items: [
          ...
          //   caption:
          //     "First design, left: mood counters and a threshold of five. Final design, right: immediate routing, with logging and self-paced gates.",
          // },
        ],
      },
      {
        ...
        blocks: [
          ...
          //   caption:
          //     "Business process flows per role — student, homeroom teacher, counselor, administration, principal, super admin.",
          // },
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "I\u2019d insist on direct discovery before the first sprint.",
          },
          {
            type: "p",
  ...
  // ===========================================================
  {
    ...
    subtitle:
      "Building an internal worksheet system for a tax and accounting consultancy",
    cardDescription:
    ...
    thumbnail: "/images/acc.png",
    meta: [
      {
        label: "Role",
        value:
          "Project Manager — requirements, backlog, delivery, stakeholder management",
      },
      {
        label: "Client",
        value: "A Jakarta accounting and tax consultancy (~10 consultants)",
      },
      { label: "Timeline", value: "Jan – Jul 2025 (5 months of delivery)" },
      {
        label: "Team",
        value:
          "7, fully remote — system analyst, database engineer, UI/UX, QA, 3 fullstack",
      },
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "p",
            text: "The clearest example is the one that became the centerpiece of the build. To pull the transactions behind a single account, a consultant did this:",
          },
          {
            type: "ul",
            items: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "h3",
            text: "Close the scope formally before writing a line of code",
          },
          {
            type: "p",
          ...
          {
            type: "h3",
            text: "Scope training and go-live into the project, not after it",
          },
          {
            type: "p",
